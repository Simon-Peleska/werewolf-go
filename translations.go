...
var translations = map[string]map[string]string{
	...
	"de": {
		...
		"returning_player_heading": "Schon dabei?",
		"returning_player_desc":    "Bereits auf einem anderen Gerät angemeldet? Gib Namen und Geheimcode ein.",
		"name_label":               "Name",
		...
		"current_votes":        "Aktuelle Stimmen",
		"vote_pass":            "Passen",
